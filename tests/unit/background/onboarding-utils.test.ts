  ...
  describe('checkOnboardingStatus', () => {
    describe('Normal Cases', () => {
      it('should return status with completed and shown true', async () => {
        ...
        expect(mockLogger.debug).toHaveBeenCalledWith('Onboarding status', status);
      });
    ...
    describe('Error Handling', () => {
      it('should handle storage access error', async () => {
        ...
        expect(mockLogger.error).toHaveBeenCalledWith('Error checking onboarding status', { error: mockError });
      });
      ...
      it('should handle chrome.storage API unavailable', async () => {
        ...
        expect(mockLogger.error).toHaveBeenCalledWith('Error checking onboarding status', { error: expect.any(Error) });
  ...
  describe('resetOnboarding', () => {
    describe('Normal Cases', () => {
      it('should remove all onboarding keys from storage', async () => {
        ...
        expect((global.chrome as any).storage.local.remove).toHaveBeenCalledWith([
          'onboardingCompleted',
          'onboardingShown',
          'installTime',
          'completedAt'
        ]);
        expect(mockLogger.info).toHaveBeenCalledWith('Onboarding status has been reset');
      });
    });
    ...
    describe('Error Handling', () => {
      it('should handle storage removal error', async () => {
        ...
        (global.chrome as any).storage.local.remove.mockRejectedValue(mockError);

        await onboardingUtils.resetOnboarding();

        expect(mockLogger.error).toHaveBeenCalledWith('Error resetting onboarding status', { error: mockError });
      });
    });
  });
  ...
  describe('markOnboardingShown', () => {
    describe('Normal Cases', () => {
      it('should set onboarding as shown with timestamp', async () => {
        ...
        expect(mockLogger.info).toHaveBeenCalledWith('Onboarding marked as shown');
    ...
    describe('Error Handling', () => {
      it('should handle storage set error', async () => {
        ...
        expect(mockLogger.error).toHaveBeenCalledWith('Error marking onboarding as shown', { error: mockError });
      });
    });
  });
  ...
  describe('markOnboardingCompleted', () => {
    describe('Normal Cases', () => {
      it('should set onboarding as completed with timestamp', async () => {
        ...
        expect(mockLogger.info).toHaveBeenCalledWith('Onboarding marked as completed');
    ...
    describe('Error Handling', () => {
      it('should handle storage set error', async () => {
        ...
        expect(mockLogger.error).toHaveBeenCalledWith('Error marking onboarding as completed', { error: mockError });
      });
    });
  });
