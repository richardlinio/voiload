  ...
  describe('handleAudioUrlRegistration', () => {
    ...
    describe('Validation and Error Handling', () => {
      ...
      it('should handle missing audioUrl', () => {
        ...
        expect(result).toBe(true);
        expect(mockLogger.error).toHaveBeenCalledWith('Missing required Audio URL or duration information');
        expect(mockSendResponse).toHaveBeenCalledWith({
          success: false,
      ...
      it('should handle registration error with custom error object', () => {
        ...
        expect(mockSendResponse).toHaveBeenCalledWith({
          success: false,
          message: 'Error occurred while registering Audio URL: Custom registration error'
        });
      });
    });
    ...
    describe('Edge Cases', () => {
      ...
      it('should handle audio URLs with special characters', () => {
        ...
        const specialUrl = 'https://example.com/audio%20file%20(1).mp3?token=abc123&v=2';
        const message = {
          audioUrl: specialUrl,
          durationMs: 6500
        };
    ...
    describe('Integration Tests', () => {
      it('should work with realistic audio URL registration workflow', () => {
        ...
        expect(result).toBe(true);
        expect(mockVoiceMessagesStore.registerDownloadUrl).toHaveBeenCalledTimes(2);
        expect(mockVoiceMessagesStore.registerDownloadUrl).toHaveBeenNthCalledWith(
          2,
          7800,
