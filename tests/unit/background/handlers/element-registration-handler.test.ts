  ...
  describe("handleElementRegistration", () => {
    describe("Normal Cases", () => {
      ...
      it("should register element and match with existing download URL", () => {
        ...
        const registeredElement =
          mockVoiceMessagesStore.items.get("element-123");
        ...
        expect((global.chrome as any).tabs.sendMessage).toHaveBeenCalledWith(
          123,
          {
    ...
    describe("Integration Tests", () => {
      it("should work with realistic registration flow", () => {
        ...
        expect(matchedElement.downloadUrl).toBe(
          "https://example.com/matched.mp3"
        );
        expect(matchedElement.lastModified).toBe(
